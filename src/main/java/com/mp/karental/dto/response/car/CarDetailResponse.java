...
public class CarDetailResponse {
    ...
    @Schema(description = "Indicates whether the car is currently booked", example = "false")
    boolean isBooked;

    @Schema(description = "Indicates whether the car is available for booking", example = "true")
    boolean isAvailable;

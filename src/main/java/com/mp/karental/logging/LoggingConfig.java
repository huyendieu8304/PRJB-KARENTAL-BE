...
public class LoggingConfig {
    ...
    private final FileSize MAX_FILE_SIZE = FileSize.valueOf("15MB");
    ...
    public void setupLogging() {
        ...
        rollingPolicy.setFileNamePattern("logs/app.%d{yyyy-MM-dd}.%i.log"); //naming for file when rolling
        ...
        rollingPolicy.setCleanHistoryOnStart(false); // Prevent deleting old logs on restart
        rollingPolicy.start();
        ...
        //Get root logger and adding appends

...
public enum ErrorCode {
    ...
    SEND_SYSTEM_CANCEL_BOOKING_EMAIL_FAIL(3025,"There was error during sending cancel booking to user.", HttpStatus.SERVICE_UNAVAILABLE),
    SEND_SYSTEM_WAITING_CONFIRM_EMAIL_FAIL(3026,"There was error during sending waiting confirm to user.", HttpStatus.SERVICE_UNAVAILABLE),
    SEND_SYSTEM_CONFIRM_DEPOSIT_EMAIL_FAIL(3027,"There was error during sending confirm deposit to user.", HttpStatus.SERVICE_UNAVAILABLE),

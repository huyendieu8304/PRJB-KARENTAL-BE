...
public enum ErrorCode {
    ...
    INVALID_CAR_STATUS_CHANGE(2024,"Car status must be NOT_VERIFIED.", HttpStatus.BAD_REQUEST),
    ...
    BOOKING_NOT_FOUND_IN_DB(3018, "The booking is not exist in the system", HttpStatus.BAD_REQUEST),
